...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    settings: {
      ...
      groqTierInfo: "Groq Cloud provides up to 30 RPM / 7,000 TPM / 14,400 RPD for free on Llama 3.3 70B.",
  ...
  uk: {
    ...
    settings: {
      ...
      groqTierInfo: "Groq Cloud безкоштовно надає до 30 RPM / 7,000 TPM / 14,400 RPD для Llama 3.3 70B.",
  ...
  pl: {
    ...
    settings: {
      ...
      groqTierInfo: "Groq Cloud oferuje bezpłatnie do 30 RPM / 7,000 TPM / 14,400 RPD dla Llama 3.3 70B.",
  ...
  es: {
    ...
    settings: {
      ...
      groqTierInfo: "Groq Cloud ofrece hasta 30 RPM / 7,000 TPM / 14,400 RPD gratis en Llama 3.3 70B.",
